"""
THIS PART OF THIS PROJECT ON ASSIGNMENT 3 is done by Richard LE and Me
"""
...
class Collectible:
    def __init__(self, x, image):
        ...
        self.image = image
        self.velocity = 4  # Velocity of the collectible falling down
        ...
        if (
            ...
            if self.image == extra_life_image:
                ...
                if player.health > 200:
                    player.health = 200  # Increase player's health but cap it at 100
                player.score += 10
...
health_boost_image = pygame.transform.scale(health_boost_image, (80, 80))  # Resize here

extra_life_image = pygame.image.load(os.path.join('images', 'lives.png'))
extra_life_image = pygame.transform.scale(extra_life_image, (40, 40))  # Resize here
...
def update_and_draw_collectibles(screen, player):
    global collectibles
    for collectible in collectibles:
        collectible.update()
        screen.blit(collectible.image, (collectible.x, collectible.y))
